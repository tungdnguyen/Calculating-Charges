import java.util.*;
import java.io.*;
public class PositiveCharge extends Charges implements INT,Serializable 
{
	...
	public PositiveCharge(double a, double b, double c)
	{
		super(a,b,c);
	}
	...
	{
		double x1 = 2*a.getX()-this.getX();
		double y1 = 2*a.getY()-this.getY();
	...
	{
		String out;
		out = "a positive charge with"+super.toString();
		return out;
	}
